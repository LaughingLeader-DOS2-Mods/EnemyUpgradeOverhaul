...
EnemyUpgradeOverhaul.UpgradeData = {
	Statuses = {
		...
		LLENEMY_TALENT_GREEDYVESSEL = UpgradeInfoData:Create(TranslatedString:Create("h4cf1c406gceb1g411fga0d9gc9832cc4d2f5", "Talent: Greedy Vessel"), "#E9D047"),
		...
		LLENEMY_TALENT_INDOMITABLE = UpgradeInfoData:Create(TranslatedString:Create("hb52d1ac1g7c4fg45a4g87d8g52056a5a2ba2", "Talent: Indomitable"), "#e94947"),
		LLENEMY_TALENT_LEECH = UpgradeInfoData:Create(TranslatedString:Create("h7e28471fg1959g47e6g9d58g4d4f8ce054f6", "Talent: Leech"), "#C80030"),
		...
		LLENEMY_TALENT_MASTERTHIEF = UpgradeInfoData:Create(TranslatedString:Create("hba05c2f9g55f0g4b5agb936g5ff5daa6877e", "Talent: Master Thief"), "#C9AA58"),
		...
		LLENEMY_TALENT_SADIST = UpgradeInfoData:Create(TranslatedString:Create("h1c81c46bg9330g4d43gba21g6b72b951b3fd", "Talent: Sadist"), "#ff5771", 2),
		LLENEMY_TALENT_SOULCATCHER = UpgradeInfoData:Create(TranslatedString:Create("h9a2a7390gc764g4fa0g8e97gf73ffac2a93c", "Talent: Soulcatcher"), "#73F6FF"),
		LLENEMY_TALENT_TORTURER = UpgradeInfoData:Create(TranslatedString:Create("h18ff40ffg5d06g48c6gb09egaec569a55aa8", "Talent: Torturer"), "#960000", 2),
		...
		LLENEMY_INF_NECROFIRE = UpgradeInfoData:Create(TranslatedString:Create("h8e75cbbdg06d7g4404gbfb2g92f6fd11147d", "Infernoblazer"), "#DD9911"),
		...
		LLENEMY_DOUBLE_DIP = UpgradeInfoData:Create(TranslatedString:Create("hf180561cge97ag426cg84ddg83dd257ce95d", "Double Dip"), "#FF22FF"),
		LLENEMY_PERSEVERANCE_MASTERY = UpgradeInfoData:Create(TranslatedString:Create("hdaeb8fa0g4a4fg4cd5gbf0eg0c7cbe96c990", "Perseverance Mastery"), "#E4CE93", 3),
		LLENEMY_BONUSSKILLS_SINGLE = UpgradeInfoData:Create(TranslatedString:Create("he79478e5gfa95g4461gba2bg9122ba540b28", "Bonus Skill"), "#F1D466"),
		LLENEMY_BONUSSKILLS_SOURCE = UpgradeInfoData:Create(TranslatedString:Create("hd1a568b1g2c56g4343gb1fcg4ae8f47c28e4", "Bonus Source Skill"), "#46B195"),
		LLENEMY_BONUSSKILLS_SET_NORMAL = UpgradeInfoData:Create(TranslatedString:Create("h5aa2a41bgbaa4g46d0g9987ge5c19c4b4aa4", "Bonus Skillset"), "#B823CB"),
		LLENEMY_BONUSSKILLS_SET_ELITE = UpgradeInfoData:Create(TranslatedString:Create("h7040a2f0g29d3g43d6ga656gb5eb0aac1934", "Elite Skillset"), "#73F6FF"),
		-- Hidden vanilla statuses
		LLENEMY_HERBMIX_COURAGE = UpgradeInfoData:Create(TranslatedString:Create("h503bd9fag7526g41abgbe28g612e3bffe6a1","Courage"), "#AAF0FF"),
		LLENEMY_HERBMIX_FEROCITY = UpgradeInfoData:Create(TranslatedString:Create("hefe488c0g2e40g4f25gb312g21899f4bbd90","Ferocity"), "#FF3322"),
