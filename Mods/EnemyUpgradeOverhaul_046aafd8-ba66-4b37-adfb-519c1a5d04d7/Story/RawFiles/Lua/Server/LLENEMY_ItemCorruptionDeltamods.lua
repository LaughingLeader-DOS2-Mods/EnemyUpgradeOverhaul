...
function LLENEMY_Server_RegisterCorruptionBoosts()
	...
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Sneaking", {Chance=10}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Sneaking_Medium", {MinLevel=8, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Sneaking_Large", {MinLevel=12, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Lockpicking", {Chance=10}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Lockpicking_Medium", {MinLevel=8, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Lockpicking_Large", {MinLevel=12, Chance=10}))
