...
function LLENEMY_Server_RegisterCorruptionBoosts()
	...
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Sneaking", {Chance=8}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Sneaking_Medium", {MinLevel=8, Chance=8}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Sneaking_Large", {MinLevel=12, Chance=8}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Lockpicking", {Chance=8}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Lockpicking_Medium", {MinLevel=8, Chance=8}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_Ability_Lockpicking_Large", {MinLevel=12, Chance=8}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_PhysicalResistance", {Chance=5}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_PhysicalResistance_Medium", {MinLevel=8, Chance=5}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_PhysicalResistance_Large", {MinLevel=12, Chance=5}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("Boost_Armor_Pants_Ability_Death", {Chance=15}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("Boost_Armor_Pants_Ability_Death_Medium", {MinLevel=8, Chance=15}))
	table.insert(EnemyUpgradeOverhaul.CorruptionBoosts.Armor, ItemBoost:Create("Boost_Armor_Pants_Ability_Death_Large", {MinLevel=12, Chance=15}))
	...
	-- Negative Boosts
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeAccuracyBoost", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeAccuracyBoost_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeAccuracyBoost_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeCriticalChance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeCriticalChance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeCriticalChance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeInitiative", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeInitiative_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeInitiative_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeDodgeBoost", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeDodgeBoost_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Weapon, ItemBoost:Create("LLENEMY_Boost_Weapon_NegativeDodgeBoost_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeBlocking", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeBlocking_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeBlocking_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeMovement", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeMovement_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeMovement_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeInitiative", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeInitiative_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeInitiative_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeDodgeBoost", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeDodgeBoost_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Shield, ItemBoost:Create("LLENEMY_Boost_Shield_NegativeDodgeBoost_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeFireResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeFireResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeFireResistance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeAirResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeAirResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeAirResistance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeWaterResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeWaterResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeWaterResistance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeEarthResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeEarthResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativeEarthResistance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePoisonResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePoisonResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePoisonResistance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePiercingResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePiercingResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePiercingResistance_Large", {MinLevel=10, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePhysicalResistance", {MinLevel=1, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePhysicalResistance_Medium", {MinLevel=6, Chance=10}))
	table.insert(EnemyUpgradeOverhaul.NegativeCorruptionBoosts.Armor, ItemBoost:Create("LLENEMY_Boost_Armor_NegativePhysicalResistance_Large", {MinLevel=10, Chance=10}))
